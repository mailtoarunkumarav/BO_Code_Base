...
import datetime
import sys
sys.path.insert(0, 'C:\Arun_Stuff\GitHubCodes\GaussianMixtures\code\explicit_construction\Branch_Krien_EVD\GP_Regressor')
...
class KernelOptimizationWrapper:
    ...
    def kernel_wrapper(self, start_time, input):
        ...
        hyperkernel_type = 'SVL_Hyperkernel'
        ...
        PH.printme(PH.p1, "Configuration Settings:\n\n", "hyperkernel_type:", hyperkernel_type, "\tkernel_type:", kernel_type,
                   ...
                   number_of_restarts_likelihood, "\thyper_char_len_scale: ", hyper_char_len_scale, "len_scale_params: ",
                   len_scale_params, "len_scale_param_bounds:", len_scale_param_bounds)
        ...
        for i in range(number_of_runs):
            ...
            hyper_gaussian_object = HyperGaussianProcess(X, hyperkernel_type, kernel_type, char_length_scale, sigma_len, sigma_len_bounds,
                                                         ...
                                                         no_principal_components, hyper_char_len_scale, len_scale_params,
                                                         len_scale_param_bounds)
