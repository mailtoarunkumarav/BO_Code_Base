...
class KernelOptimiser:
    ...
    def optimise_kernel(self, run_count):
        ...
        PH.printme(PH.p1, "Calculating predictive likelihood for the kernel: ")
        self.gp_wrapper_obj.compute_predictive_likelihood_for_kernel('HYPER', self.best_solution['best_kernel'],
