...
class NormUtility:
    ...
    def inifinity_norm_calculator_csv_experiment1(self, filename1, filename2):
        ...
        PH.printme(PH.p1, "Reading File 2 : Linear kernel")
        ...
        l1norm = np.linalg.norm(kernel_diff, ord=1, axis=0)

        PH.printme(PH.p1, "Experiment2: KFO vs Linear Kernel \nInfinity norm Difference: ", inf_norm, "\nL2-Norm Difference: ", l2norm,
                   "\nL1-Norm Difference: ", l1norm)
