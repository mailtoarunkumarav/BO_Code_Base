...
class GaussianProcessWrapper:
    ...
    def construct_gp_regressor_syn(self, stamp, posterior_plot, role):
 ...
 # [14.96720056],
 # [12.89137917],
 # [13.68806056],[13.60453255]])

        # Triangular  wave working - 2 peaks
 ...
 # [9.97376045],
 # [8.31310333],
 # [5.40044845], [3.53362604]])

        # Triangular wave zero centered and zero mean
 #        X = np.array([[-5.74213622],
 # [-4.15033511],
 # [-4.11927195],
 # [-5.14109277],
 # [-3.52518744],
 ...
 #        X = np.vstack(X)
        ...
        if role == "groundtruth":
            gaussian_object.runGaussian(-1, "LIN", None, None)
            gaussian_object.compute_predictive_loglikelihood_linear("LIN")
            return gaussian_object
    ...
    def compute_predictive_likelihood_for_kernel(self, kernel_type, observations_kernel, optional_hypergp_obj):

        PH.printme(PH.p1, "Computing predictive llk for KFO: ", observations_kernel)
        likelihood = self.gaussian_object.compute_predictive_loglikelihood(kernel_type, observations_kernel, optional_hypergp_obj)
        return likelihood
