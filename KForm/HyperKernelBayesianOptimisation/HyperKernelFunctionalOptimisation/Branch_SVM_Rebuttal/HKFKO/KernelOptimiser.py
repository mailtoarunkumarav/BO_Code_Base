...
class KernelOptimiser:
    ...
    def generate_observations(self, kernel_bias, basis_weights, kernel_samples):
        ...
        # Commented for MKL implementation
        ...
        observations_kernel, observations_y = self.svm_wrapper_obj.compute_accuracy('HYPER', kernel_bias, basis_weights, kernel_samples,
                                                               self.hyper_gaussian_object)
    ...
    def sample_basis_weights(self):
        ...
        weights = np.random.uniform(self.hyper_gaussian_object.basis_weights_bounds[0], self.hyper_gaussian_object.basis_weights_bounds[
            1], self.hyper_gaussian_object.number_of_basis_vectors_chosen+3
        ).reshape(-1, 1)
