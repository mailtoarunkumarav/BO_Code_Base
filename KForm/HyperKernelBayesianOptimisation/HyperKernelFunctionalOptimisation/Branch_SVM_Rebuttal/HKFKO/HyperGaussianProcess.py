...
class HyperGaussianProcess:
    ...
    def predict_for_hypergp(self, lambda_weights):
        ...
        for i in range(len(lambda_weights)):
            k_new[i] = lambda_weights[i][0] * self.current_kernel_bias + lambda_weights[i][1] * self.current_kernel_samples[0] + \
                       lambda_weights[i][2] * self.current_kernel_samples[1]
    ...
    def estimate_kernel_for_Xtil(self, datapointx1, datapointx2, kernel_bias, basis_weights, kernel_samples):
