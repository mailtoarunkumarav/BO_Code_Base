...
class GPR_Generic : public ML_Base
{
public:
    ...
    virtual double C(void)         const { return 1/dsigma;                }
    virtual double sigma(void)     const { return dsigma;                  }
    virtual double eps(void)       const { return getQconst().eps();       }
    virtual double Cclass(int d)   const { (void) d; return 1.0;           }
    ...
    virtual const Vector<gentype>                &y          (void) const { return dy;                        }
    ...
    virtual const Vector<double>                 &Cweight    (void) const { return dCweight;                  }
    virtual const Vector<double>                 &Cweightfuzz(void) const { return getQconst().Cweightfuzz(); }
    virtual const Vector<double>                 &sigmaweight(void) const { return dsigmaweight;              }
    ...
    virtual int sety(int                i, const gentype         &nv) {                           dy("&",i)       = nv; return getQ().sety(i,nv); }
    virtual int sety(const Vector<int> &i, const Vector<gentype> &nv) { retVector<gentype> tmpva; dy("&",i,tmpva) = nv; return getQ().sety(i,nv); }
    virtual int sety(                      const Vector<gentype> &nv) {                           dy              = nv; return getQ().sety(  nv); }

    virtual int sety(int                i, double                nv) {                           dy("&",i) = nv;                 return getQ().sety(i,nv); }
    virtual int sety(const Vector<int> &i, const Vector<double> &nv) { retVector<gentype> tmpva; dy("&",i,tmpva).castassign(nv); return getQ().sety(i,nv); }
    virtual int sety(                      const Vector<double> &nv) {                           dy.castassign(nv);              return getQ().sety(  nv); }

    virtual int sety(int                i, const Vector<double>          &nv) { int ires = getQ().sety(i,nv);                                 dy("&",i)       = getQconst().y()(i);       return ires; }
    virtual int sety(const Vector<int> &i, const Vector<Vector<double> > &nv) { int ires = getQ().sety(i,nv); retVector<gentype> tmpva,tmpvb; dy("&",i,tmpva) = getQconst().y()(i,tmpvb); return ires; }
    virtual int sety(                      const Vector<Vector<double> > &nv) { int ires = getQ().sety(  nv);                                 dy              = getQconst().y();          return ires; }

    virtual int sety(int                i, const d_anion         &nv) { int ires = getQ().sety(i,nv);                                 dy("&",i)       = getQconst().y()(i);       return ires; }
    virtual int sety(const Vector<int> &i, const Vector<d_anion> &nv) { int ires = getQ().sety(i,nv); retVector<gentype> tmpva,tmpvb; dy("&",i,tmpva) = getQconst().y()(i,tmpvb); return ires; }
    virtual int sety(                      const Vector<d_anion> &nv) { int ires = getQ().sety(  nv);                                 dy              = getQconst().y();          return ires; }
    ...
    virtual int setCweightfuzz(int i,                double nv               ) { (void) i; (void) nv; throw("Weight fuzzing not available for gpr models"); return 1; }
    virtual int setCweightfuzz(const Vector<int> &i, const Vector<double> &nv) { (void) i; (void) nv; throw("Weight fuzzing not available for gpr models"); return 1; }
    virtual int setCweightfuzz(                      const Vector<double> &nv) {           (void) nv; throw("Weight fuzzing not available for gpr models"); return 1; }
    ...
    virtual int scaleCweightfuzz(double s) { (void) s; throw("Weight fuzzing not available for gpr models"); return 1; }
    ...
    virtual int setsigma(double xsigma)         { dsigma = xsigma; return getQ().setC(1/sigma()); }
    virtual int seteps  (double xeps)           { return getQ().seteps(xeps);                     }
    virtual int setCclass  (int d, double xC)   { (void) d; (void) xC; throw("Weight classing not available for gpr models"); return 1; }
    ...
    virtual ML_Base &operator*=(double sf) { getQ().scale(sf); return *this; }
    ...
    virtual int isSampleMode(void) const { return sampleMode; }
...
//    virtual void dgTrainingVector(Vector<d_anion>         &res, d_anion        &resn, int i) const { return getQconst().dgTrainingVector(res,resn,i); }
    ...
    virtual void dg(Vector<double>          &res, double         &resn, const gentype &y, const SparseVector<gentype> &x) const { getQconst().dg(res,resn,y,x); return; }
    virtual void dg(Vector<Vector<double> > &res, Vector<double> &resn, const gentype &y, const SparseVector<gentype> &x) const { getQconst().dg(res,resn,y,x); return; }
    virtual void dg(Vector<d_anion>         &res, d_anion        &resn, const gentype &y, const SparseVector<gentype> &x) const { getQconst().dg(res,resn,y,x); return; }
    ...
    virtual int var(gentype &resv, gentype &resmu, const SparseVector<gentype> &xa, const vecInfo *xainf = NULL, gentype ***pxyprodx = NULL, gentype **pxyprodxx = NULL) const;
    ...
    virtual int setmuWeight(const Vector<gentype> &nv) { return getQ().setgamma(nv); }
    virtual int setmuBias  (const gentype         &nv) { return getQ().setdelta(nv); }
    ...
    virtual int isZeromuBias(void) const { return getQconst().isZerodelta(); }
    virtual int isVarmuBias (void) const { return getQconst().isVardelta();  }

    virtual int setZeromuBias(void) { return getQ().setZerodelta(); }
    virtual int setVarmuBias (void) { return getQ().setVardelta();  }

    // Likelihood

    virtual double loglikelihood(void) const { return getQconst().lsvloglikelihood(); }
