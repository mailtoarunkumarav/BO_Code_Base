...
public:
    ...
    virtual int addTrainingVector (int i, const gentype &z, const SparseVector<gentype> &x, double Cweigh, double epsweigh);
    virtual int qaddTrainingVector(int i, const gentype &z,       SparseVector<gentype> &x, double Cweigh, double epsweigh);
    ...
    virtual int setCweightfuzz(int i, double xCweight)                               { return locgetSVM().setCweightfuzz(i,xCweight); }
    virtual int setCweightfuzz(const Vector<int> &i, const Vector<double> &xCweight) { return locgetSVM().setCweightfuzz(i,xCweight); }
    virtual int setCweightfuzz(const Vector<double> &xCweight)                       { return locgetSVM().setCweightfuzz(xCweight); }
...
private:
    ...
    virtual       SVM_Generic &locgetSVM     (void)       { if ( isQatonce &&  isQreal ) { return static_cast<      SVM_Generic &>(Qatonce);  } else if ( isQatonce && !isQreal ) { return static_cast<      SVM_Generic &>(QMatonce); } else if ( !isQatonce && isQreal ) { return static_cast<      SVM_Generic &>(Qredbin); } return static_cast<      SVM_Generic &>(QMredbin); }
    virtual const SVM_Generic &locgetSVMconst(void) const { if ( isQatonce &&  isQreal ) { return static_cast<const SVM_Generic &>(Qatonce);  } else if ( isQatonce && !isQreal ) { return static_cast<const SVM_Generic &>(QMatonce); } else if ( !isQatonce && isQreal ) { return static_cast<const SVM_Generic &>(Qredbin); } return static_cast<const SVM_Generic &>(QMredbin); }
