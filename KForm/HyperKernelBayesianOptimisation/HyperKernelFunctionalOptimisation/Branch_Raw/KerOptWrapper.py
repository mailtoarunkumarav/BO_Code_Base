...
import sys
import sys
sys.path.insert(0, 'C:\Arun_Stuff\GitHubCodes\KForm\HyperKernelBayesianOptimisation\HyperKernelFunctionalOptimisation\Branch_Raw'
                   '\GP_Regressor')
...
class KernelOptimizationWrapper:
    ...
    def ker_opt_wrapper(start_time):

        # Number of data points in X  for the grid
        number_of_samples_in_X_for_grid = 5
        ...
        number_of_subspace_selection_iterations = 10
        number_of_iterations_best_solution = 10
        ...
        print("Configuration Settings:\n\n", "hyperkernel_type:", hyperkernel_type, "\tkernel_type:", kernel_type, "\tchar_length_scale:",
              ...
              acq_fun_list, "\nLength scale bounds: ", len_scale_bounds, "\tnumber of restart likelihoods: ", number_of_restarts_likelihood)
        ...
        for i in range(number_of_runs):
            ...
            hyper_gaussian_object = HyperGaussianProcess(X, hyperkernel_type, kernel_type, char_length_scale, sigma_len, sigma_len_bounds,
                                                         ...
                                                         no_principal_components)

            acquisition_utility_object = AcquisitionUtility(None, number_of_restarts_acq, extrema_type)

            gp_wrapper_obj = GaussianProcessWrapper()
            gp_wrapper_obj.construct_gp_regressor()
            ...
            if 'UCB' in acq_fun_list:
                ...
                print("Best solution found for run: ", i+1, kernel_optimiser_obj.best_solution)
                ...
                print("Maximum log marginal likelihood obtained: ", maximum_likelihood)
                plt.show()
