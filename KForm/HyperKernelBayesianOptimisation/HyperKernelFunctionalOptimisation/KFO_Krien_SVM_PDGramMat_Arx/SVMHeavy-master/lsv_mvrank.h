...
public:
    ...
    virtual int type(void)      const { return 510;          }
    ...
    virtual int addTrainingVector (int i, double z, const SparseVector<gentype> &x, double Cweigh = 1, double epsweigh = 1, int d = 2) { return getQ().addTrainingVector (i,z,x,Cweigh,epsweigh,d); }
    virtual int qaddTrainingVector(int i, double z,       SparseVector<gentype> &x, double Cweigh = 1, double epsweigh = 1, int d = 2) { return getQ().qaddTrainingVector(i,z,x,Cweigh,epsweigh,d); }
