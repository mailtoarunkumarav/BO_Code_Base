...
class KernelOptimiser:
    ...
    def optimise_kernel(self, run_count):
        ...
        PH.printme(PH.p4, 'Initial Grid Values selected for this run\n--- X in Grid ---\n', self.hyper_gaussian_object.X)
        ...
        for subspace_selection_count in range(self.number_of_subspace_selection_iterations):
            ...
            PH.printme(PH.p2, "Best solution is selected as \n", self.best_solution)
            # PH.printme(PH.p1, "\nObservations_kernel:", self.complete_dataset_kernel_observations)
            PH.printme(PH.p1, "@@@@@@@@@@@@@@@@@@@@@s", (subspace_selection_count+1), "comp@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n")
            PH.printme(PH.p1, "@@@@@@@@@@@@@@@@@@Data_s", (subspace_selection_count+1),  "@@@@@@@@@@@@@@@@@@@@@@@@@")
