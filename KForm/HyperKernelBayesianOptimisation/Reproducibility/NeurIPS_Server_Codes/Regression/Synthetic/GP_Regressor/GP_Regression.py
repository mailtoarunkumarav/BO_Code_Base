...
class GaussianProcess:
    ...
    def plot_posterior_distribution(self, kernel_type, observations_kernel, optional_hypergp_obj, msg):
        ...
        PH.printme(PH.p1, "compute for test points ")
...
if __name__ == "__main__":
    ...
    if cmd_inputs != {}:
        PH.printme(PH.p1, "Synthetic Function: ", cmd_inputs["function"])
    else:
        PH.printme(PH.p1, "Synthetic Function Default")
