...
class KernelOptimizationWrapper:
    ...
    def kernel_wrapper(self, start_time, input, cmd_inputs):
        ...
        if input is not None:
            ...
            PH.printme(PH.p3, "Inputs Supplied: ", input)
        ...
        if not synthetic_data:
            PH.printme(PH.p3, "Dataset: ", dataset)
        ...
        for i in range(number_of_runs):
            ...
            if 'UCB' in acq_fun_list:
                ...
                PH.printme(PH.p3, "Best solution found:", i+1,":", kernel_optimiser_obj.best_solution)
        ...
        PH.printme(PH.p3, "\n\n@@@@@@@Mean likelihood for Bayesian Optimisation after ",run_count," runs: ", mean_min_likelihood)
