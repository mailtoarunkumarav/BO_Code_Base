...
class KernelOptimizationWrapper:
    ...
    def kernel_wrapper(self, start_time, input, cmd_inputs):
        ...
        PH.printme(PH.p3, "Configuration Settings:\n\n", "hyperkernel_type:", hyperkernel_type, "\tkernel_type:", kernel_type, "\tchar_length_scale:",
              ...
              "\tbasis_weights_bounds:", basis_weights_bounds,
        ...
        for i in range(number_of_runs):
            ...
            if 'UCB' in acq_fun_list:
                ...
                PH.printme(PH.p3, "Best solution found for", i+1, kernel_optimiser_obj.best_solution)

                maximum_accuracy = svm_wrapper_obj.compute_accuracy('HYPER', best_solution_found['best_kernel'],
                                                                                  hyper_gaussian_object)
                PH.printme(PH.p3, "Maximum accuracy obtained: ", maximum_accuracy)
                ...
                #                                                                   hyper_gaussian_object)
                # PH.printme(PH.p3, "Maximum log marginal likelihood obtained: ", maximum_likelihood)
