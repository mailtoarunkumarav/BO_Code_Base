...
class AcquisitionFunction():
    ...
    def max_acq_func(self, gp_obj, Xs, ys, iteration_count):
        ...
        if (self.acq_type == 'pi'):
            ...
            PH.printme(PH.p3, "PI Best is ", fmax, "at ", x_max_value)
        ...
        # Find maxima of the ACQ function using UCB
            ...
            PH.printme(PH.p3, "UCB Best is ", fmax, "at ", x_max_value)
            ...
            # used to verify if the maxima value is really found at 0
            # if(x_max_value==[0]):
            #     PH.printme(PH.p3, tempfvals, tempmax_x)
        ...
        # Find maxima of the ACQ function using EI
            ...
            PH.printme(PH.p3, "EI Best is ", fmax, "at ", x_max_value)
