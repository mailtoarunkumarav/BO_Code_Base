...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time, cmd_inputs):
        ...
        for i in range(number_of_runs):
            ...
            PH.printme(PH.p3,"..........Constructing observation model ...........")

            y = np.array([])
            obs_count=0
            for each_hyper_set in X:
                obs_count += 1
                PH.printme(PH.p3, ".............Generating observation: ", obs_count, "...................")
                max_likeli = bay_opt_obj.func_helper_obj.get_true_func_value(each_hyper_set)
                y=np.append(y, max_likeli)

            PH.printme(PH.p3, "..........Observation model complete...........")
            ...
            PH.printme(PH.p3, "..........Normalising observation model complete...........")
            ...
            PH.printme(PH.p3, "Computing regret for initial points: ",init_regret)
            ...
            if ('ei' in acq_fun_list):
                ...
                for iter_type in kernel_iter_types:
                    ...
                    if(iter_type == 'ard'):
                        PH.printme(PH.p3, "Testing with ARD Kernel in Run: ", (i+1))
                        ...
                        PH.printme(PH.p3, "Testing with Varying Kernel in Run: ", (i + 1))
                        ...
                        PH.printme(PH.p3, "Testing with fixed Kernel in Run: ", (i + 1))
                        gaussianObject.params_estimation = False
                        gaussianObject.len_scale_estimation = False
                        ...
                        PH.printme(PH.p3, "Testing with multi Kernel in Run: ", (i + 1))
