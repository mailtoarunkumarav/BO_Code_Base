...
class HyperGaussianProcess:
    ...
    def __init__(self, X, hyperkernel_type, kernel_type, char_length_scale, sigma_len, sigma_len_bounds, signal_variance_bounds,
                 ...
                 number_of_restarts_likelihood, no_principal_components):
    ...
    def matern_harmonic_hyperkernel(self, datapoint1, datapoint2, datapoint3, datapoint4):
        ...
        factor1 = (1+((np.sqrt(3)/char_len_scale)*l2_difference1))*(1+((np.sqrt(3)/char_len_scale)*l2_difference2))
        factor2 = np.exp((-1 * np.sqrt(3) / char_len_scale) * (l2_difference1 + l2_difference2))
        ...
        for each_krien_kernel_index in range(self.number_of_basis_vectors_chosen):
            ...
            for kri_index in range(len(krien_eigen_values)):
                if krien_eigen_values[kri_index] < 0:
                    # print("Negative Eigen for Krien Kernel, updating the value")
    ...
    def generate_basis_as_kernel_samples(self):
        ...
        print("Eigen values for the calculation of the dimensionality reduction...")
        ...
        self.principal_eigen_values = eigen_values[(total_components - self.no_principal_components):total_components]
        self.principal_eigen_vectors = eigen_vectors[:, (total_components - self.no_principal_components):total_components]
    ...
    def compute_hyperparams_kernel_observations(self):
        print("Hyper Params for kernel observations")
        ...
        print("Opt Length scale: ", self.char_length_scale, "\nOpt variance: ", self.signal_variance)
    ...
    def predict_for_hypergp(self, lambda_weights):
        ...
        # print("*****",lambda_weights, self.current_kernel_samples, "******" )
...
'''
    ...
    def fit_hypergp_for_observations(self, observations_kernel, observations_y, Xs):
        ...
        print("fitting observations to the kernel", observations_y)
