...
import sys
import sys
sys.path.insert(0, '/home/aanjanapuravenk/Workstation_Maps/Functional_Kernel_Optimisation/GP_Regressor')
...
class KernelOptimizationWrapper:
    ...
    def ker_opt_wrapper(start_time):
        ...
        number_of_samples_in_X_for_grid = 60
        number_of_samples_in_Xs_for_grid = 20
        ...
        number_of_subspace_selection_iterations = 20
