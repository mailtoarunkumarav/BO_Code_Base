...
class HumanExpertModel:
    ...
    def construct_human_expert_model(self, run_count, pwd_qualifier, number_of_observations_groundtruth, function_type, gp_wrapper_obj,
                                     number_of_random_observations_humanexpert, noisy_suggestions, estimated_kernel):
        ...
        gp_groundtruth = gp_wrapper_obj.construct_gp_object(pwd_qualifier, "GroundTruth", number_of_observations_groundtruth,
                                                            function_type, None, estimated_kernel)
        ...
        # Non-noisy assumption
        # noise_he_obs = np.random.normal(0, 0.1, number_of_random_observations_humanexpert).reshape(-1, 1)
        # gp_humanexpert.y = gp_humanexpert.y + noise_he_obs
        ...
        # MKL for Human expert
        # PH.printme(PH.p1, "Human Expert with info from Ground truth kernel: ", gp_groundtruth.len_weights,   "Var:",
        #            gp_groundtruth.signal_variance)
    ...
    def obtain_human_expert_suggestions(self, suggestion_count, file_identifier, gp_humanexpert, acq_func_obj, noisy_suggestions,
        ...
        if self.human_expert_input_method != "suggestion_correction":
            ...
            # Commenting for more runs
            # plot_axes = [0, 1, acq_func_values_worst.min() * 0.7, acq_func_values_worst.max() * 2]
            # acq_func_obj.plot_acquisition_function(file_identifier + "_Test_Worst_acq_" + str(suggestion_count), gp_humanexpert.Xs,
