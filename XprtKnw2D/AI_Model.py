...
class AIModel:
    ...
    def optimise_kernel(self, gp_aimodel, run_count, start_time, number_of_ai_suggestions, acq_func_obj):
        ...
        for ai_suggestion_count in range(len(gp_aimodel.X)+1,  number_of_ai_suggestions+len(gp_aimodel.X)+1):
            ...
            PH.printme(PH.p1, "Suggestion: ", ai_suggestion_count, " complete")
            gp_aimodel.X = X
            gp_aimodel.y = y
    ...
    def minimise_suggestions_distance_arxiv(self, gp_aimodel, acq_func_obj, ai_suggestion_count):
        ...
        xnew_suggestion, acq_func_values = acq_func_obj.max_acq_func("ai", gp_aimodel, ai_suggestion_count + 1)
    ...
    def distance_minimiser_arxiv(self, inputs, gp_aimodel, acq_func_obj, ai_suggestion_count, print_bool="FF"):
        ...
        xnew, acq_func_values = acq_func_obj.max_acq_func("ai", gp_aimodel, ai_suggestion_count + 1, print_bool)
        self.xnew_temp = xnew
