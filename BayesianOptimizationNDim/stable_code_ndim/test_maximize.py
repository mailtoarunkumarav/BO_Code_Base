...
# # testing non positive definiteness of the matrix.
len_scale_params =  [[0.6, 0.3],[0.6, 0.5]]
signal_variance =1

X=np.array([[0.94763226, 0.42830868],
 [0.22654742, 0.76414069],
 [0.59442014, 0.00286059],
 [0.39642163, 0.34751073],
 [0.55574287, 0.55759693],
 [0.63214604, 1.        ],
 [1.        , 0.98274072],
 [0.64829137, 0.3017525 ],
 [0.54360233, 0.76412908],
 [0.54437686, 0.6147124 ],
 [0.36703344, 0.97685806],
 [0.60122811, 0.60580519],
 [0.        , 0.37483962]])

y=np.array([[0.68216227],
 [0.77345516],
 [0.8331158 ],
 [0.91272527],
 [0.98993122],
...
def var_sq_exp_kernel( data_point1, data_point2, char_len_scale, signal_variance):
...
K_x_x = var_sq_exp_kernel(X, X, 0.1, signal_variance)
# print(K_x_x)
eye = 1e-9 * np.eye(len(X))
Knoise = K_x_x + eye
z = np.linalg.pinv(Knoise)
print(np.linalg.eigvals(Knoise))
print(z)
exit(0)
L_x_x = np.linalg.cholesky(Knoise)
print(L_x_x)
factor = np.linalg.solve(L_x_x, y)
