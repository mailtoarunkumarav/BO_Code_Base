...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time):
        ...
        if true_func == 'sin' or true_func == 'cos' or true_func == 'custom':
            ...
            len_scale_params = np.array([[0.5, 0.4], [0.5, 0.4]])
            len_scale_param_bounds = [[[0.4, 0.6], [0.3, 0.5]], [[0.4, 0.6], [0.3, 0.5]]]
            ...
            number_of_dimensions = 2
            egg2d_bounds = [[-512,512], [-512,512]]
            bounds = egg2d_bounds
            epsilon1 = 0.001
            epsilon2 = 0
            number_of_iterations = 40
            len_scale_func_type = ['gaussian', 'gaussian']
            # len_scale_params = np.array([[0.5, 0.3], [0.5, 0.3]])
            len_scale_params = np.array([[0.42100132, 0.55166192], [0.58834757, 0.33032216]])
            len_scale_param_bounds = [[[0.4, 0.6], [0.3, 0.8]], [[0.4, 0.6], [0.3, 0.8]]]
        ...
        len_scale_bounds = [[0.01, 3] for nd in np.arange(number_of_dimensions)]
        ...
        kernel_iter_types = ['var_l', 'ard', 'fix_l']
        ...
        print("\n\nParameters\nTrue Func", true_func, "\tDim:", number_of_dimensions, "\tobs_samp:", number_of_observed_samples,
              ...
              "\tBounds:", bounds, "\tl_params:", len_scale_params, "\tl_param_bds:", len_scale_param_bounds,"\tlen_scale_bds:",len_scale_bounds,
              "\nxmax:", Xmax, "\txmin:", Xmin, "\tymax:", ymax, "\tymin:", ymin, "\teps1:", epsilon1, "\teps2:", epsilon2,
              "\tfixed_l:", char_length_scale, "\tSig_var:", signal_variance, "\tSig_var_bds:", signal_variance_bounds, "\tTest_points:",
              number_of_test_datapoints, "\n\n")
