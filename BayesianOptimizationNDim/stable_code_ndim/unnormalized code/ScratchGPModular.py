...
class GaussianProcess:
    ...
    def plot_prior_samples(self,name, Xs, f_prior):

        # Specify the parameters required for plotting the prior
        plot_prior_params = {'plotnum': name ,
    ...
    def plot_posterior_samples(self, name, Xs, f_post):

        plot_posterior_sample_params = {'plotnum': name ,
                                        'axis': [self.linspacexmin, self.linspacexmax, self.linspaceymin,
                                                 self.linspaceymax],
