...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time):
        ...
        if true_func == 'sin' or true_func == 'cos' or true_func == 'custom':
            ...
            len_scale_func_type = ['linear', 'linear']
            len_scale_params = np.array([[0.3, 0.1], [0.3, 0.1]])
            len_scale_param_bounds = [[[0.1, 1], [0.1, 0.5]], [[0.1, 1], [0.1, 0.5]]]
        ...
        elif true_func == 'shubert2d':
            number_of_dimensions = 2
            shubert_bounds = [[-2,2], [-2,2]]
            bounds = shubert_bounds
            epsilon1 = 0.001
            epsilon2 = 0.001
            number_of_iterations = 30
            len_scale_func_type = ['linear', 'linear']
            len_scale_params = np.array([[0.3, 0.1], [0.3, 0.1]])
            len_scale_param_bounds = [[[0.5, 1.2], [0.1, 0.2]], [[0.5, 1.2], [0.1, 0.2]]]
        ...
        multi_len_scales = [0.7,0.3,0.2,0.1]
        len_weights = [1,1,1,1]
        ...
        print("\n\nParameters\nTrue Func", true_func, "\tDim:", number_of_dimensions, "\tobs_samp:", number_of_observed_samples,
              ...
              number_of_test_datapoints,"\tlen_weights: ",len_weights,"\tmulti_len_scales", multi_len_scales,"\tl_wts_bds:",
              len_weight_bounds,"\n\n")
