...
class FunctionHelper:
    ...
    def get_true_max(self):
        ...
        elif (self.true_func_type == 'shubert2d'):
            true_max = self.get_true_func_value(np.matrix([-1.42492492, -0.7992993]))
    ...
    def get_true_func_value(self, x):
        if (self.true_func_type == 'sin'):
            ...
            # #Shubert 2d function  Maxima = 186.72850542 @ x = [-1.42492492, -0.7992993]
