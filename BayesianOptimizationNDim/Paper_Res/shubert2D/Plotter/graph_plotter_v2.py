...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('shubert2d.txt', 'rt') as data_file:
            ...
            plt.title('Regret shubert 2D Function')
            ...
            fig.savefig("shu2d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("shu2d_reg.eps", pad_inches=0, bbox_inches='tight')
