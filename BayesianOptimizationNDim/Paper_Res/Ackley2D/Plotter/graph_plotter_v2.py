...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('ackley2d.txt', 'rt') as data_file:
            ...
            plt.title("Regret Ackley 2D Function")
            fig.savefig("ack2d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("ack2d_reg.eps", pad_inches=0, bbox_inches='tight')
