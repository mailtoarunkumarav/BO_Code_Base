...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('gclee.txt', 'rt') as data_file:
            ...
            plt.title('Regret Gramacy Lee 1D Function')
            ...
            fig.savefig("gclee1d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("gclee1d_reg.eps", pad_inches=0, bbox_inches='tight')
