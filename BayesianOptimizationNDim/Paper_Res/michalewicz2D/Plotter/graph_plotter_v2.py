...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('michalewicz2d.txt', 'rt') as data_file:
            ...
            plt.title('Regret michalewicz 2D')
            ...
            fig.savefig("mic2d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("mic2d_reg.eps", pad_inches=0, bbox_inches='tight')
