...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time):
        ...
        if true_func == 'sin' or true_func == 'cos' or true_func == 'custom':
            ...
            len_scale_params = np.array([[0.5, 0.4]])
            len_scale_param_bounds = [[[0.4, 0.7], [0.5, 0.8]]]

            # len_scale_func_type = ['quadratic']
            # len_scale_params = np.array([[-2, 1, 1.1]])
            # len_scale_param_bounds = [[[2, 2.1], [-2.1, 2], [0.65,0.75]]]
            ...
            len_scale_param_bounds = [[[0.5, 0.55], [0.17, 0.3]], [[0.5, 0.55], [0.17, 0.3]]]
        ...
        len_scale_bounds = [[0.5, 2] for nd in np.arange(number_of_dimensions)]
        ...
        multi_len_scales = [0.7,0.5,0.3,0.4]
        len_weights = [1,1,1,1]
