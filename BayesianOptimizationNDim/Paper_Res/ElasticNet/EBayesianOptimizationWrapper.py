...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time):
        ...
        if true_func == 'sin' or true_func == 'cos' or true_func == 'custom':
            ...
            # Iris WDBC
            # len_scale_param_bounds = [[[0.3, 0.7], [0.6, 1]], [[0.3, 0.7], [0.6, 1]]]

            #Wine
            len_scale_param_bounds = [[[0.1, 0.5], [0.6, 1]], [[0.1, 0.5], [0.6, 1]]]
        ...
        elif true_func == 'elastic_net':
            number_of_dimensions = 2
            elastic_bounds = [[-7, -1], [0, 1]]
            ...
            len_scale_func_type = ['gaussian', 'gaussian']
            len_scale_params = np.array([[0.7, 0.4], [0.5, 0.4]])

            # vehicle
            len_scale_param_bounds = [[[0.01, 0.3], [0.4, 0.6]], [[0.6, 1], [0.4, 0.6]]]
        ...
        len_scale_bounds = [[0.1, 0.5] for nd in np.arange(number_of_dimensions)]

        # characteristic_length_scale = np.array([1 for nd in np.arange(number_of_dimensions)])
        char_length_scale = [0.3 for nd in np.arange(number_of_dimensions)]
        ...
        multi_len_scales = [0.7,0.3,0.01,0.05]
        len_weights = [1,1,1,1]
        ...
        kernel_iter_types = [ 'fix_l', 'ard', 'var_l','m_ker']
        ...
        print("\n\nParameters\nTrue Func", true_func, "\tDim:", number_of_dimensions, "\tobs_samp:", number_of_observed_samples,
              ...
              number_of_test_datapoints,"\tlen_weights: ",len_weights,"\tmulti_len_scales", multi_len_scales,"\tp:-(1),+1.1", "\n\n")
        ...
        for i in range(number_of_runs):
            ...
            for each_hyper_set in X:
                accuracy = bay_opt_obj.func_helper_obj.get_true_func_value(each_hyper_set)
