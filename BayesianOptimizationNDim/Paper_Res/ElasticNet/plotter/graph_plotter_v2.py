...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        # with open('elastic_vehicle.txt', 'rt') as data_file:
        with open('elastic_wdbc.txt', 'rt') as data_file:
        ...
        # with open('svmtune_wine.txt', 'rt') as data_file:
            ...
            # plt.title('(a) ElasticNet Accuracy:Vehicle',  y=-0.26)
            plt.title('(b) ElasticNet Accuracy:WDBC', y=-0.26)
            ...
            ax.legend(custom_lines, label_type,loc=4, fontsize='medium')
            ...
            # fig.savefig("elastic_vehicle.pdf", pad_inches=0, bbox_inches='tight')
            # fig.savefig("elastic_vehicle.eps", pad_inches=0, bbox_inches='tight')

            fig.savefig("elastic_wdbc.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("elastic_wdbc.eps", pad_inches=0, bbox_inches='tight')

            # plt.autoscale(tight=True)

            # ax.legend(custom_lines, label_type,loc=4, fontsize='large')
