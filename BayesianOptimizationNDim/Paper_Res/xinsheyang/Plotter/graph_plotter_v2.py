...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('xin1d.txt', 'rt') as data_file:
            ...
            plt.title('Regret Xin-She Yang 1D Function')
            ...
            fig.savefig("xin1d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("xin1d_reg.eps", pad_inches=0, bbox_inches='tight')
