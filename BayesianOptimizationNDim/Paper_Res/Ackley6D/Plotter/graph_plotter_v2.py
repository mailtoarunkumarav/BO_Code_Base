...
class GraphPlotter:
    ...
    def plotGraph(time_stamp):
        ...
        with open('ackley6d.txt', 'rt') as data_file:
            ...
            for myline in data_file:
                ...
                if (re.search('Regret Deviation_std_error'.lower(), myline.lower())):
            ...
            plt.title('Simple Regret Ackley 6D')
            ...
            ax.legend(custom_lines, fun_type,loc=1, fontsize='large')
            fig.savefig("ack6d_reg.pdf", pad_inches=0, bbox_inches='tight')
            fig.savefig("ack6d_reg.eps", pad_inches=0, bbox_inches='tight')
