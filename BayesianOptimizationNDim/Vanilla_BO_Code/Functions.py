...
class FunctionHelper:
    ...
    def get_true_max(self):
        ...
        if (self.true_func_type == 'custom'):
            # Bias 0.01 added to avoid negative regret (as true maxima is not known, accuracy up to 5 points after decimal)
            true_max = self.get_true_func_value(2.00020826)+0.01
