...
xnew = np.array([0.77777778, 0.77777778, 0.77777778])

xorig = np.multiply(xnew.T,(Xmax-Xmin))+Xmin
print("OriginalL: ", xorig)
...
yy = z_func(X1,X2)
x = np.arange(0.1, 0.3, 0.00001)
y = np.arange(0.1, 0.3, 0.00001)
