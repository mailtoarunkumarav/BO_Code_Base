...
class GaussianProcess:
    ...
    def len_scale_func_linear(self,data_point_value):

        a = self.len_scale_params[0][0]
        b = self.len_scale_params[0][1]
    ...
    def len_scale_func_quad(self, data_point_value):

        a = self.len_scale_params[1][0]
        b = self.len_scale_params[1][1]
        c = self.len_scale_params[1][2]
            ...
            for j in np.arange(len(data_point2)):
                ...
                for d in np.arange(len(data_point1[i, :])):
                    ...
                    if self.len_scale_func_type[d] == 'linear':
                        len_scale_vector_datapoint1 = self.len_scale_func_linear(data_point1[i, :][d])
                        len_scale_vector_datapoint2 = self.len_scale_func_linear(data_point2[j, :][d])

                    elif self.len_scale_func_type[d] == 'quadratic':
                        len_scale_vector_datapoint1 = self.len_scale_func_quad(data_point1[i, :][d])
                        len_scale_vector_datapoint2 = self.len_scale_func_quad(data_point2[j, :][d])
    ...
    def optimize_log_marginal_likelihood_l_params(self, input):
        ...
        self.len_scale_params[0] = np.array(input)
