...
class BayesianOptimizationWrapper:
    ...
    def opt_wrapper(start_time):
        ...
        if true_func == 'sin' or true_func == 'cos' or true_func == 'custom':
            ...
            len_scale_param_bounds = [[[0.001, 2], [0.001, 1]], [[0.001, 2], [0.001, 1]]]
        ...
        # kernel_iter_types = ['ard', 'var_l', 'fix_l']
        kernel_iter_types = ['var_l','ard']
